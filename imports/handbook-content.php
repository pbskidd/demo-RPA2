...
<div class="breadcrumbs">
    <h2 class="pull-right text-info pbbanner"><strong>Parent Handbook</strong></h2>
</div>
<!--/Banner-->
...
<script type="text/javascript">
 ...
 var liLabel = '<i class="fa fa-lock"> PARENT HANDBOOK';
...
var tmpItem = tempList[3].getElementsByTagName("A")[0];
...
<div class=" privacy col-md-9">
	<div class="row">
<iframe src="imports/handbook-content2.php" width="100%" height="600" frameborder="0" scrolling="no" >
